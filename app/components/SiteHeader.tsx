...
export function SiteHeader({ people }: { people: Member[] }) {
  ...
  return (
    <header className="bg-paper">
      <div className="flex items-stretch overflow-hidden border-b border-rule">
        <div className="flex flex-shrink-0 items-center border-r border-rule px-6 py-4 md:px-8">
          <Wordmark />
        </div>
